...
bool BaseRenderTarget::read(int W, int H, int C, uint8_t * d) {
	auto o = outputs_.find({W, H});
	if (o != outputs_.end())
...
bool BaseRenderTarget::read(int W, int H, int C, uint16_t * d) {
	auto o = outputs_.find({W, H});
	if (o != outputs_.end())
		return o->second->read(d, C);
	LOG(WARN) << "Output of size " << W << " x " << H << " not requested. Reading failed!";
...
bool BaseRenderTarget::read(int W, int H, int C, uint32_t * d) {
	auto o = outputs_.find({W, H});
	if (o != outputs_.end())
		return o->second->read(d, C);
	LOG(WARN) << "Output of size " << W << " x " << H << " not requested. Reading failed!";
...
bool BaseRenderTarget::read(int W, int H, int C, half * d) {
	auto o = outputs_.find({W, H});
	if (o != outputs_.end())
		return o->second->read(d, C);
	LOG(WARN) << "Output of size " << W << " x " << H << " not requested. Reading failed!";
...
bool BaseRenderTarget::read(int W, int H, int C, float * d) {
	auto o = outputs_.find({W, H});
	if (o != outputs_.end())
		return o->second->read(d, C);
	LOG(WARN) << "Output of size " << W << " x " << H << " not requested. Reading failed!";
