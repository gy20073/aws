...
class Scenario:
    def __init__(self, location=None, time=None, weather=None, vehicle=None,
                 drivingMode=None):
...
class Dataset:
    def __init__(self, rate=None, frame=None, vehicles=None, peds=None,
                 trafficSigns=None, direction=None, reward=None,
                 throttle=None, brake=None, steering=None, speed=None,
                 yawRate=None, drivingMode=None, location=None, time=None,
                 collision=None, roadinfo=None):
        self.rate = rate  # Hz
        ...
        self.roadinfo = roadinfo  # boolean
...
class Start:
    ...
    def to_json(self):
        ...
        return json.dumps(
            {'start': {'scenario': _scenario, 'dataset': _dataset}})
...
class Config:
    ...
    def to_json(self):
        ...
        return json.dumps(
            {'config': {'scenario': _scenario, 'dataset': _dataset}})
...
class Commands:
    def __init__(self, throttle=None, brake=None, steering=None, manual=False):
...
def frame2numpy(frame, frameSize):
    ...
    return as_strided(buff, strides=(strideWidth, 3, 1),
                      shape=(frameSize[1], frameSize[0], 3)).copy()
