...
if("TRUE" STREQUAL "TRUE")
  set(mkz_intel_SOURCE_PREFIX /data/yang/code/aws/catkin_ws/src/mkz_intel)
  set(mkz_intel_DEVEL_PREFIX /data/yang/code/aws/catkin_ws/devel)
  ...
  set(mkz_intel_INSTALL_PREFIX /data/yang/code/aws/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mkz_intel' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/data/yang/code/aws/catkin_ws/src/mkz_intel/${idir}'.  ${_report}")
    endif()
...
set(mkz_intel_EXPORTED_TARGETS "")
